/*
 * @(#) at_uni_salzburg_cs_ckgroup_io_BluetoothSocketInputStream.c
 *
...
#include <at_uni_salzburg_cs_ckgroup_io_BluetoothSocketInputStream.h>
...
#ifdef DEBUG
        debug ("bluetoothSocketRead0  fd=%d, data=%p, ofs=%d, len=%d, numBytes=%d\n",
