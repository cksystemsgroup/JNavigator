/*
 * @(#) AltitudeControllerParametersTestCase.java
 *
...
/**
 * This tests verify the implementation of class <code>AttitudeControllerParameters</code>.
 * 
 * @author Clemens Krainer
 */
public class AltitudeControllerParametersTestCase extends TestCase {

	/**
	 * Test the construction out of double values against the getter methods.
	 */
	public void testCase01 () {
		AltitudeControllerParameters params = new AltitudeControllerParameters (1, -1, 2, -2);
	...
	public void testCase02 () {
		...
		AltitudeControllerParameters base = new AltitudeControllerParameters (1, -1, 2, -2);
		byte[] expected = base.toByteArray();
		
		AltitudeControllerParameters params;
		try {
			params = new AltitudeControllerParameters (expected);
	...
	public void testCase03 () {
		...
		assertEquals ("AltitudeControllerParameters: kProportional=1000, kIntegral=-1000, kDerivative=2000, kSecondDerivative=-2000", actual);
	}
	...
	public void testCase04 () {
		...
		try {
			AltitudeControllerParameters base = new AltitudeControllerParameters (ba);
			assertNull (base);
		} catch (CommunicationException e) {
