/*
 * @(#) AttitudeControllerParametersTestCaseTestCase.java
 *
 ...
 */
public class AttitudeControllerParametersTestCase extends TestCase {

	/**
	 * Test the construction out of double values against the getter methods.
	 */
	public void testCase01 () {
		AttitudeControllerParameters params = new AttitudeControllerParameters (1, -1, 2, -2);
	...
	public void testCase02 () {
		...
		AttitudeControllerParameters params;
		try {
			params = new AttitudeControllerParameters (expected);
	...
	public void testCase04 () {
		...
		try {
			AttitudeControllerParameters base = new AttitudeControllerParameters (ba);
			assertNull (base);
		} catch (CommunicationException e) {
