/*
 * @(#) YawControllerParametersTestCase.java
 *
...
/**
 * This tests verify the implementation of class <code>YawControllerParameters</code>.
 * 
 * @author Clemens Krainer
 */
public class YawControllerParametersTestCase extends TestCase {

	/**
	 * Test the construction out of double values against the getter methods.
	 */
	public void testCase01 () {
		YawControllerParameters params = new YawControllerParameters (1, -1, 2, -2);
	...
	public void testCase02 () {
		...
		YawControllerParameters params;
		try {
			params = new YawControllerParameters (expected);
	...
	public void testCase04 () {
		...
		try {
			YawControllerParameters base = new YawControllerParameters (ba);
			assertNull (base);
		} catch (CommunicationException e) {
