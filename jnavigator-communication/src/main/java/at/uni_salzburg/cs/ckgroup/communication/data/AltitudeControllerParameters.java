/*
 * @(#) AltitudeControllerParameters.java
 *
...
/**
 * This class contains all control parameters for the altitude controller
...
public class AltitudeControllerParameters extends ControllerParameters {
	 ...
	 */
	public AltitudeControllerParameters(double kProportional, double kIntegral,
	 ...
	 */
	public AltitudeControllerParameters(byte[] data)
			throws CommunicationException {
		super(data);
	}
	...
	public String toString() {
		return "AltitudeControllerParameters: " + super.toString();
	}
}
