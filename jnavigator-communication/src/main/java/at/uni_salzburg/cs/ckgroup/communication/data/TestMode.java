...
public class TestMode implements IDataTransferObject {
	...
	/**
	 * Construct an <code>TestMode</code> object.
	 * 
	 * @param mode the test mode flag
	 */
	public TestMode (boolean mode) {
	...
	/**
	 * @return true in the test mode is enabled, false otherwise. 
	 */
	...
	public String toString () {
		...
		buf.append("TestMode: mode=").append(data != 0);
		return buf.toString();
	}
}
