...
public class AltitudeLimit implements IDataTransferObject {

	/**
	 * The scaling factor of the altitude limit value.
	 */
	static final double LIMIT_FACTOR = 0.9;
    ...
    /**
     * Construct an <code>AltitudeLimit</code> object.
     * 
     * @param limit the altitude limit
     */
    public AltitudeLimit (double limit) {
    	this.limit = (short) (limit * LIMIT_FACTOR);
    }
    
    /**
     * Construct an <code>AltitudeLimit</code> object from a byte array.
     * 
     * @param data the byte array that contains the data.
     */
    public AltitudeLimit (byte[] data) {
    	int k = 0;
	...
	public String toString () {
		...
		buf.append("AltitudeLimit: limit=").append(limit);
		return buf.toString();
	}
}
