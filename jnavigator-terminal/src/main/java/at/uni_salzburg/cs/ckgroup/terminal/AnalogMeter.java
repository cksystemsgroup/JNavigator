...
//    public static final int    DEG_360          = 6284; // mrad
    ...
    public boolean isValidMaximum( double angle )
    {
...
//        }
    ...
    public boolean isValidDesired( double angle )
    {
        switch( meterType )
        {
            case TYPE_ROLL:
...
//        }
    ...
    {
//    	if (angle > 0.2) System.out.println("rotateNeedle: " + angle);
        ...
        transformation.setToRotation( angle, originX, originY );
	...
	private class Painter extends Thread {
		List<AnalogMeter> meters = new ArrayList<AnalogMeter>();

		public void run() {
			while (true) {
				for (AnalogMeter m : meters) {
