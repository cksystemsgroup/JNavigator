...
import at.uni_salzburg.cs.ckgroup.location.ILocationMessageListener;
...
public class Ubs2GpsMain extends TestCase {

	public static void main (String[] args) {
		Ubs2GpsMain testCase = new Ubs2GpsMain ();
		testCase.runDaemon ();
	}
	...
	public void runDaemon () {
		String propsPath1 = "ubs2gps.properties";
		String propsPath2 = "at/uni_salzburg/cs/ckgroup/lab/Ubs2Gps/ubs2gps.properties";
		
		Properties props = null;
		try {
			props = PropertyUtils.loadProperties(propsPath1);
		} catch (IOException e) {
			System.out.println ("Can not find " + propsPath1 + " now trying " + propsPath2);
		}
		
		try {
			if (props == null)
				props = PropertyUtils.loadProperties(propsPath2);
			...
			ILocationMessageListener positionProvider = p instanceof ILocationMessageListener ? (ILocationMessageListener)p : null;
			...
			long cycle = Integer.parseInt (props.getProperty("gps.simulator.cycle","1000"));
			Timer timer1 = new Timer ();
	        timer1.schedule (gpsReceiverSimulator, 100, cycle);
