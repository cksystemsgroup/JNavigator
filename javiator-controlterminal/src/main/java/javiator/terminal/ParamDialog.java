...
public class ParamDialog extends Dialog
{
        ...
        short[] controlParams, int[] changedParamID )
    {
        if( Instance == null )
        {
            Instance = new ParamDialog( parent, title, controlParams, changedParamID );
        }
    ...
    private static final String[] REV_PARAMS     = { "Limit", "Rev +", "Rev -", "Ki -" };
    ...
    private TextField[]           paramLabels    = null;
        ...
        short[] controlParams, int[] changedParamID )
    {
        ...
        paramLabels         = new TextField[ controlParams.length ];
...
//      setSize( getWidth( ), parent.getHeight( ) );
    ...
    private void makePanel( )
    {
        ...
        {
        	paramLabels[i] = new TextField( ControlTerminal.NIL
                + (double) controlParams[i] / SCALING_FACTOR, Label.RIGHT );
        	
        	paramLabels[i].addTextListener(new IDTextListener(i, paramLabels[i]));
    ...
    private class IDTextListener implements TextListener
    {
    	IDTextListener (int adapterID, TextField parent)
    	{
    		super( );
    		this.adapterID = adapterID;
    		this.parent = parent;
		...
		public void textValueChanged(TextEvent e) {
			controlParams[getAdapterID( )] = (short)(SCALING_FACTOR * Double.parseDouble(parent.getText()));
			changedParamID[0] = getAdapterID( );
		}
